...
$art_style = '';
$art_head = '';
function histomed_sys_process_html(&$variables) {
...
function histomed_sys_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function histomed_sys_button($variables) {
 ...
 */
function histomed_sys_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function histomed_sys_menu_local_task($variables) {
 ...
 */
function histomed_sys_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function histomed_sys_node_preview($variables) {
  $node = $variables['node'];
...
*/
function histomed_sys_form_alter(&$form, &$form_state, $form_id) {
...
function histomed_sys_form_element_label($variables) {
...
function histomed_sys_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function histomed_sys_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
