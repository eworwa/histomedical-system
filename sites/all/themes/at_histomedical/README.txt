...
8. Finally go to the theme settings page for AT Histomedical. Find the vertical tab for "Slideshow".
   Make sure:
...
## Theming the Slideshow
  ...
  AT Histomedical comes with a CSS file called styles.slideshow.css - in here are most of the styles for
  the default styling. There is a small amount in at_histomedical.responsive.style.css to re-position
  the directional navigation arrows when in small screens.

  You can modify these CSS files directly, or subtheme AT Histomedical using Footheme:
