            ...
            <div id="branding" class="branding-elements clearfix<?php print $branding_classes ? ' ' . $branding_classes : ''; ?>">
              ...
              <?php if ($site_name || $site_slogan): ?>
                ...
                <div id="name-and-slogan"<?php print $hgroup_attributes; ?>>
                  ...
                  <?php if ($site_name): ?>
                    <div class='title-page'><h1 id="site-name"<?php print $site_name_attributes; ?>><?php print $site_name; ?></h1></div>
                  <?php endif; ?>
            ...
            <div class="content-inner">
              ...
              <<?php print $tag; ?> id="main-content">
                ...
                <?php if ($title && !isset($node)): ?>
                  <header>
                    <div class='title-page'><h1 id="page-title"><?php print $title; ?></h1></div>
                  </header>
                <?php endif; ?>
